...
type ChannelCmdFactory struct {
	EndorserClient   pb.EndorserClient //背书服务连接
	Signer           msp.SigningIdentity //签名服务连接
	BroadcastClient  common.BroadcastClient //orderer交易接收服务连接
	DeliverClient    deliverClientIntf //区块存储服务连接
