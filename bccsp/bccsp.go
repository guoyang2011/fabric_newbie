...
// KeyGenOpts contains options for key-generation(秘钥生成) with a CSP.
type KeyGenOpts interface {
	...
	// false otherwise. ephemeral 短暂的
	Ephemeral() bool
}

// KeyDerivOpts contains options for key-derivation(秘钥导出) with a CSP(cryptographic service provider).
