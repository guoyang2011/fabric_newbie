...
type General struct {
	// 账本存储类型:
	// 	file: 文件存储fsblkstorage，实现包github.com/hyperledger/fabric/orderer/ledger/file
	// 	json: 文件存储格式为json,实现包 github.com/hyperledger/fabric/orderer/ledger/json
	// 	ram: 内存存储，实现包 github.com/hyperledger/fabric/orderer/ledger/ram
	LedgerType     string
